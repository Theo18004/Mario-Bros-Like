...
extern Mix_Chunk *sonJC;
extern Mix_Chunk *sonEcrasement;
extern Mix_Chunk *sonMortJoueur;
extern Mix_Chunk *sonLoup;
extern Mix_Chunk *sonAlien;
extern Mix_Chunk *sonDefaite;
