 ...
 */
void reset_level(Player* p, Ennemi* loup, Thwomp* thwomps, Podoboo* mesPodoboo, Coquilas* mesCoquilas, Ennemi* jc, Piece* pieces, Score* s, Camera* cam, int total_reset , int levelID);
